...
class Logger:
    ...
    def __init__(self, model, scheduler, ckpt_path, total_steps):
        self.model = model
    ...
    def _print_training_status(self):
        ...
        training_str = "[steps: {:6d}] ".format(self.total_steps + 1)
        metrics_str = ("1px: {:6.3f}, 3px: {:6.3f},  5px: {:6.3f},  epe: {:6.3f}").format(*metrics_data)
