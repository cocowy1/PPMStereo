...
def run_test_eval(ckpt_path, eval_type, evaluator, model, dataloaders, writer, step):
    ...
    # for real_sequence_name in ["teddy_static", "nikita_reading",  "ignacio_waving", ]:
    #     seq_len_real = 50
    #     ds_path = f"/home/ywang/dataset/DynamicReplica/real/{real_sequence_name}"
    ...
    for ds_name, dataloader in dataloaders:
        evaluator.visualize_interval = 0 
