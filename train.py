...
def forward_batch(batch, model, args):
    ...
    if args.name == "memstereo" or args.name == "memstereo_vpt":
...
class Lite(LightningLite):
    def run(self, args):
        ...
        if  args.name == 'bidastereo':
            ...
            num_frames=args.sample_len,
            attention_type=args.attention_type,
            use_vpt_head=args.use_vpt_head,
            use_3d_update_block=args.update_block_3d,
            use_convex_3d=args.use_convex_3d,
            different_update_blocks=args.different_update_blocks,
        )
        ...
        if args.name == 'ppmstereo' or 'ppmstereo_vda':
        ...
        while should_keep_training:
            ...
            for i_batch, batch in enumerate(tqdm(train_loader)):
                ...
                if self.global_rank == 0:
                    ...
                    if total_steps > 80000 and total_steps % args.evaluate_freq == 0:
                        ckpt_iter = "0" * (7 - len(str(total_steps))) + str(total_steps)
                        save_path = Path(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--name", default="ppmstereo", choices=["ppmstereo", "bidastereo", "ppmstereo_vda", "dynamic"])
    parser.add_argument("--ckpt_model", default=None, type=str, help="restore checkpoint")
    parser.add_argument("--ckpt_path", default='/home/ywang/my_projects/PPMStereo/exp/', help="path to save checkpoints")
    parser.add_argument(
    ...
    parser.add_argument(
        "--train_datasets",
        nargs="+",
        default=["dynamic_replica", "things", "monkaa", "driving"],
