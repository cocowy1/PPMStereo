...
from models.core.model_zoo import (
...
@hydra.main(config_path="/data/ywang/my_projects/dynamic_stereo/evaluation/configs/",
            config_name="eval_dynamic_replica_40_frames")
