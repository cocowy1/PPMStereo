...
class PPMStereoModel(Configurable, torch.nn.Module):

    MODEL_CONFIG_NAME: ClassVar[str] = "MemStereoModel"

    # model_weights: str = "./checkpoints/dynamic_stereo_sf.pth"
    model_weights: str = "/home/ywang/my_projects/ppmstereo/ckpt/ppmstereo_final.pth"
    kernel_size: int = 20
