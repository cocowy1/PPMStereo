...
from models.core.bidastereo_update import (
    MultiSequenceUpdateBlock3D,
)
from models.core.extractor import BasicEncoder, ResidualBlock
from models.core.corr import TFCL

from models.core.utils.utils import InputPadder, interp
from models.raft_model import RAFTModel
...
class BiDAStereo(nn.Module):
    ...
    def forward(self, seq1, seq2, flow_init=None, iters=20, test_mode=False):
        b, T, *_ = seq1.shape
